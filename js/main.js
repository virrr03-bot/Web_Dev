...
function initializeClubs() {
  if (!localStorage.getItem("vit_clubs")) {
    const defaultClubs = {
      Saarthi: new Club(
        "Saarthi",
        "Your guide to opportunities and college life"
      ),
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  document
    .querySelectorAll(".btn, .club-card, .feature-card")
    .forEach((element) => {
  ...
  // Smooth scroll functionality for hero section
  ...
  // Parallax effect on scroll for hero content
